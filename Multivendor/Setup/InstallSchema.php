...
//        $installer->getConnection()->dropTable($installer->getTable('multivendor_vendor_product'));
        if(!$installer->tableExists('multivendor_vendor')){
            $table = $installer->getConnection()->newTable(
                $installer->getTable('multivendor_vendor')
            )->addColumn(
                'vendor_id', \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER, null,
                ['identity' => true, 'unsigned' => true, 'nullable' => false, 'primary' => true],
                'vendor_id ID'
            )->addColumn(
                'vendor_code', \Magento\Framework\DB\Ddl\Table::TYPE_TEXT, 30,
                ...
                'logo', \Magento\Framework\DB\Ddl\Table::TYPE_TEXT, null,
                ['nullable' => true],
                'Logo'
            )->addColumn(
                ...
                'address', \Magento\Framework\DB\Ddl\Table::TYPE_TEXT, null,
                ['nullable' => false, 'default' => ''],
                'Address'
            )->addColumn(
                'phone', \Magento\Framework\DB\Ddl\Table::TYPE_TEXT, null,
                ['nullable' => false, 'default' => ''],
                'Phone'
            )->addColumn(
        ...
        if(!$installer->tableExists('multivendor_vendor_product')){

            $table = $installer->getConnection()->newTable(
                $installer->getTable('multivendor_vendor_product')
            )->addColumn(
                'vendor_product_id', \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER, null,
                ['identity' => true, 'unsigned' => true, 'nullable' => false, 'primary' => true],
                'ID'
            )->addColumn(
                'vendor_id', \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER, null,
